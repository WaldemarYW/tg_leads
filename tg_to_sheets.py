...
FORM_TEXT = (
    "Залишився останній крок перед передачею тімліду — анкета.\n"
    "Можна надіслати все одним повідомленням, а документ окремо.\n\n"
    "Будь ласка, надішліть:\n\n"
    "1️⃣ ПІБ\n"
    "2️⃣ Дата народження\n"
    "3️⃣ Номер телефону\n"
    "4️⃣ Електронна пошта (Gmail)\n"
    "5️⃣ Посилання на Telegram\n"
    "6️⃣ Місто проживання\n"
    "7️⃣ Графік роботи\n"
    "8️⃣ Дата, з якої готові розпочати навчання та стажування\n"
    "9️⃣ Документ для верифікації\n"
    "Паспорт, закордонний паспорт, водійські права, студентський або військовий квиток (на вибір).\n"
    "Ви можете закрити всі дані, залишивши лише фото, дату народження, ПІБ і номер документа.\n"
    "🛡 Якщо хвилюєтеся — просто додайте на зображення напис типу: \"тільки для співпраці з Furioza Company\" або \"не для банку\".\n"
    "Документ потрібен лише для внутрішньої верифікації та створення Вашого особистого кабінету.\n"
    "Після анкети передаю Вас тімліду і погоджуємо зручну дату старту.\n"
    "Чекаю на відповідь."
)
