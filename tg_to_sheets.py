...
SHIFTS_TEXT = (
    "Компанія пропонує 2 зміни на вибір — ви обираєте одну і працюєте на постійній основі:\n\n"
...
FORMAT_TEXT = (
    ...
    "де розповідається про формат роботи, обовʼязки та основні умови.\n\n"
    "Також у вас є можливість пройти наш міні-курс на сайті-тренажері,\n"
    "там можна на практиці побачити, як виглядає звичайна робоча зміна:\n"
    "інтерфейс, логіка роботи та реальні приклади завдань.\n\n"
    "Ви можете обрати формат, який буде зручнішим саме для вас."
)
...
MINI_COURSE_LINK = "alpha-mini.pp.ua"
