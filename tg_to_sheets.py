...
SHIFTS_TEXT = (
    "У вас є вибір із кількох графіків:\n"
    "- Денна 14:00–23:00\n"
    "- Нічна 23:00–08:00\n"
    "Щодо вихідних: у тебе є 8 вихідних днів на місяць, береш коли зручно, будні це дні чи вихідні - не важливо)"
)
SHIFT_QUESTION_TEXT = "Який графік роботи тобі підходить?"
FORMAT_TEXT = (
